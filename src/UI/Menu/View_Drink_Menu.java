// This class is use for view drink's records in database
/*
...
public class View_Drink_Menu extends JFrame {
    ...
    static final String DRINK_QUERY = "SELECT * FROM Product Where PROD_TYPE = 'Drink'";
    private TablesModel tableModel;
    private TableRowSorter<TablesModel> sorter;
    private JTable resultTable; 
    
    public View_Drink_Menu() {
        super("Menu Result");

        try {
            tableModel = new TablesModel(DATABASE_URL, USERNAME, PASSWORD, DRINK_QUERY);

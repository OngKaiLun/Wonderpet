//This class is use for search staff details in database
/*
...
static private String DATABASE_URL = "jdbc:derby://localhost:1527/GUIAssignment";
    ...
    public Search_staff(){
        code = (String) JOptionPane.showInputDialog(null,"Enter Staff ID","Search Staff ID",JOptionPane.QUESTION_MESSAGE);
        if(code != null){

        try {
             String a = "Select * FROM Staff Where SF_ID ='"+code+"'";
